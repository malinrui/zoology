...
config = TrainConfig(
    ...
    model=ModelConfig(
        ...
        # init_with_kqvo="trained_models/TransformerBlock_lr_0.00046_d_128_kv_16_seq_64.pth",
        # attn_layers=[0, 1, 2, 3],
    ),
    logger=LoggerConfig(
        project_name="zoo-3",
    ...
    load_from_pretrained_path = "trained_models/TransformerBlock_lr_0.00046_d_128_kv_16_seq_64.pth",
    save_model = False,
